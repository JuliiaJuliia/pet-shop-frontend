...
const saleSection = [
    ...
    { id: 2, name: "Ultra Cat Litter Tray Self-Cleaning", image: "/Cat Litter.jpg" },
    { id: 3, name: "Black Dog Bed, Large Dogs", image: "/Dog Bed.jpg" },
    { id: 4, name: "Cat Toy with Real Random Trajectory", image: "/Dog and Fish.jpg" },
  ];
